...
export const UserItem = ({ user, handleFunction }) => {
  ...
  return (
    <Box className='userItem' display='flex' alignItems='center' gap='10px' p='5px 10px' bg='#EBEBEB' mb='5px'
     boxShadow='1px 1px 3px black' borderRadius='5px' onClick={() => handleFunction(user._id)}>
