...
export const SenderProfile = ({imageUrl,handleFunction,showProfile}) => {
  return (<>
      ...
      <Box className='profileViewer' zIndex='10' opacity={showProfile?'1':'0'} pointerEvents={showProfile?'all':'none'} overflow='hidden' width='300px' aspectRatio='1/1' position='absolute' left='50%' top='50%' transform='translate(-50%,-50%)' bg='gray'>
